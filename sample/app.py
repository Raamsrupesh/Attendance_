...
if not st.session_state['user_auth']:
    ...
    if who == '👨‍🏫 Mentor':  
            ...
            if a == "🧑 STUDENT":
                ...
                ">
                  ...
                  ">
                    ...
                    <div style="font-size:1.5rem;font-weight:600;">{datime.now().date().day - student_portal_pre}</div>
        ...
        with st5:
            ...
            if st.session_state['device_id'] in ['45c71d8124d5773d2afc93d2716451a4be8cfcb955bf6d8acdca26066cacc755','1f399fbb313d1aaabbfcf8265f53cca63aa13c9c3cbc4203b5a4791276d7ee3b', '2a16b84b390ab4863191248fb0c1e2c45710160a29fb5d22a261232a8eab4c18']:
                ...
                try:
                    ...
                    st.info("The default passwords are activated!")
