                            ...
                            if role == 'Student':
                                ...
                                if rep_pass == "":
                                    ...
                                    with col2:
                                        ...
                                        with col2:
                                            col = st.columns(1)
                                            attendance_data = pd.concat(['Date':[selected_date_str] * max(len(absent_list), len(present_list)), 'Presenties':daily_attendance['Name'], 'Absenties':absent_df], ignore_index=True) 
