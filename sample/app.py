...
options = ['X1', 'X2', 'X3', 'X4', 'X5', 'X6', 'X7', 'X8', 'X9','Y0', 'Y1', 'Y2', 'Y3', 'Y4', 'Y5', 'Y6', 'Y7', 'Y8', 'Y9','Z0', 'Z1', 'Z2', 'Z3', 'Z4', 'Z5', 'Z6', 'Z7', 'Z8', 'Z9', 'AA', 'AB', 'AC', 'AD', 'AE', 'AF', 'AG', 'AH', 'AI', 'AJ', 'AK', 'AL', 'AM',
...
if role == 'Student':
    ...
    if st.button('Reset Attendance for Selected Date') and rep_pass == rep_password:
        attendance_df = pd.DataFrame(columns=['Name', 'Date']) 
        attendance_df.to_csv(ATTENDANCE_FILE, index=False)
