                            ...
                            if role == 'Student':
                                ...
                                if rep_pass == "":
                                    ...
                                    with col2:
                                        ...
                                        with col2:
                                            col = st.columns(1)
                                            ment_attendance_df=(pd.concat([pd.Series(data=[selected_date_str] * max(len(present_list), len(absent_list))),daily_attendance['Name'], absent_df], axis=1,ignore_index=True))
