                            ...
                            if role == 'Student':
                                ...
                                if rep_pass == "":
                                    ...
                                    with col2:
                                        ...
                                        with col2:
                                            col = st.columns(1)
                                            attendance_data = (pd.concat(['Date':(pd.Series([selected_date_str] * max(len(absent_list), len(present_list)))), 'Presenties':daily_attendance['Name'], 'Absenties':absent_df], axis=1,ignore_index=True)) 
